...
def get_pretraining_set_pointcloud(opts):

    from feeder.feeder_pretraining_point import Feeder_pointcloud
    training_data = Feeder_pointcloud(**opts.train_feeder_args)
